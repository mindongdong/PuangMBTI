const qnaList = [
    {
        ...
        a: [
            { answer: "1. 그래 좋아!", type: "E" },
            { answer: "2. 안 먹었지만 이미 먹었다고 하고 빠르게 지나간다.", type: "I" }
        ]
    },
    {
        q: "Q. 일곱 난쟁이들이 “우리 나가서 놀 건데 같이 나가서 놀래? 아니면 집에 있을 래?” 라고 한다면 나는?",
        a: [
            { answer: "1. 완전 좋지! 어디 가는데?", type: "E" },
            { answer: "2. 아니... 나는 집에 있을래 다녀와~", type: "I" }
        ]
    },
    {
        q: "Q. 무도회에 초대받은 나, 무도회 시작 3시간전에 신데렐라 발목부상으로 무도회가 취소되었다. 이때 나는?",
        a: [
            { answer: "1. 앗싸! 더 자야지!", type: "I"},
            { answer: "2. 준비 다했는데...옷 다 준비했는데... 기대했는데... 너무해푸앙....", type: "E"}
        ]
    },
    {
        q: "Q. 빨간 사과를 발견했다. 빨간 사과를 보고 나는?",
        a: [
            { answer: "1. 색이 빨갛고 예쁘네! ", type: "S"},
            { answer: "2. 독 사과 아니야? 백설공주가 이거 먹고 쓰러졌었는데...", type: "N"}
        ]
    },
    {
        q: "Q. 동화 출품 마감이 내일인데, 마지막장이 써지지 않는다. 이때 나는?",
        a: [
            { answer: "1. 아직도 생각을 못하고 있다니, 나한테 실망이야.", type: "S"},
            { answer: "2. (제때 마감 못해서 출판사 팀장님을 실망시키고 사람들에게 쪽팔림 당해서 결국 매장당하는 온갖 극단적인 최악의 상황들을 상상함)", type:"N"}
        ]
    },
    {
        q: "Q. 견우와 직녀랑 함께 까치가 연결해준 다리로 건너가고 있었는데, 직녀가 “너 여기서 떨어지면 누구를 구할 거야?”라고 물었다. 이때 나는?",
        a: [
            { answer: "1. 그런 생각을 왜 해? 너가 왜 떨어져?", type:"S"},
            { answer: "2. 진지하게 고민해서 답해준다.", type:"N"}
        ]
    },
    {
        q: "Q. 라푼젤이 탈모가 왔다. 이때 나는?",
        a: [
            { answer: "1. 이 발모샴푸가 좋다던데, 이거 한번 써봐. 초기에 관리하는게 중요해", type:"T"},
            { answer: "2. 속상하겠다... 근데 너 원래 머리 숱 많았어서 하나도 티 안나!", type:"F"}
        ]
    },
    {
        q: "Q. 알리바바가 양탄자를 타고 가던 중 새들과 부딪히는 사고가 났다. 이때 나의 반응은?",
        a: [
            { answer: "1. 괜찮아? 안 다쳤어? 많이 놀랐겠다.", type:"F"},
            { answer: "2. 양탄자 보험은 들었어?", type:"T"}
        ]
    },
    {
        q: "Q. 겁쟁이 사자가 양철 나무꾼한테 혼나고 울고 있다. 이때 나는?",
        a: [
            { answer: "1. 무슨 일이야... 그래도 이렇게까지 말하는 건 심한 거 아닌가? 괜찮아?", type:"F"},
            { answer: "2. 왜 혼났는데? 울지 말고 이야기해봐", type:"T"}
        ]
    },
    {
        q: "Q. 약속시간까지 10분이 남았는데 시계토끼가 시간이 없다면서 나를 재촉한다. 이때 나는?",
        a: [
            { answer: "1. 이미 계산했지! 2분이따 출발해도 안 늦어! 괜찮아", type:"J"},
            { answer: "2. 괜찮아 늦으면 택시 타고 가면 되지~", type:"P"}
        ]
    },
    {
        q: "Q. 할 일이 아직 많이 남아 있는 데 도깨비가 같이 놀자고 한다. 이때 나는?",
        a: [
            { answer: "1. 오늘 이거 끝내야 해서 안될 것 같아! 다음에 놀자~", type:"J"},
            { answer: "2. 할 일은 내일 해도 돼! 같이 가자~", type:"P"}
        ]
    },
    {
        q: "Q. 팥쥐 엄마가 돌아오기 전까지 집안일을 다 끝내 놓으라고 한다. 이때 나는?",
        a: [
            { answer: "1. 뭐부터 해야 할지 계획을 정하고 실행한다.", type:"J"},
            { answer: "2. 일단 눈에 보이는 것부터 치우기 시작한다.", type:"P"}
        ]
    },
];
